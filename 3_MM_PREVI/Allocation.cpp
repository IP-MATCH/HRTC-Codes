		...
		/*			if(idDtoC[idxDoc] != -1){
						for(int n=0; n < couples[idDtoC[idxDoc]].preferences1.size();n++){		
							for(int o=0; o < couples[idDtoC[idxDoc]].preferences1[n].size();o++){	
								if(couples[idDtoC[idxDoc]].preferences1[n][o]-1 == j && couples[idDtoC[idxDoc]].preferences2[n][o]-1 == j && ((couples[idDtoC[idxDoc]].id1 == idxDoc && couples[idDtoC[idxDoc]].ranks1[n][o] >= couples[idDtoC[idxDoc]].ranks2[n][o]) || (couples[idDtoC[idxDoc]].id2 == idxDoc && couples[idDtoC[idxDoc]].ranks2[n][o] >= couples[idDtoC[idxDoc]].ranks1[n][o]))) {
									cout << "Couple " << couples[idDtoC[idxDoc]].id1 << "-" << couples[idDtoC[idxDoc]].id2 << " cannot get something worse than ( " << j << "," << j << ")" << endl;
									for(int p=n+1 ; p<couples[idDtoC[idxDoc]].preferences1.size(); p++){
										for(int q=0; q < couples[idDtoC[idxDoc]].preferences1[p].size();q++){	
											int idxHos1 = couples[idDtoC[idxDoc]].preferences1[p][q]-1;
											for(int r=0; r<hospitals[idxHos1].preferences[couples[idDtoC[idxDoc]].ranks1[p][q]-1].size();r++){						
												if(hospitals[idxHos1].preferences[couples[idDtoC[idxDoc]].ranks1[p][q]-1][r] == couples[idDtoC[idxDoc]].id1){
													hospitals[idxHos1].preferences[couples[idDtoC[idxDoc]].ranks1[p][q]-1].erase(hospitals[idxHos1].preferences[couples[idDtoC[idxDoc]].ranks1[p][q]-1].begin() + r); 
													hospitals[idxHos1].nbTotPref--;
													nbTotRem++;
												}
											}
											int idxHos2 = couples[idDtoC[idxDoc]].preferences2[p][q]-1;
											for(int r=0; r<hospitals[idxHos2].preferences[couples[idDtoC[idxDoc]].ranks2[p][q]-1].size();r++){						
												if(hospitals[idxHos2].preferences[couples[idDtoC[idxDoc]].ranks2[p][q]-1][r] == couples[idDtoC[idxDoc]].id2){
													hospitals[idxHos2].preferences[couples[idDtoC[idxDoc]].ranks2[p][q]-1].erase(hospitals[idxHos2].preferences[couples[idDtoC[idxDoc]].ranks2[p][q]-1].begin() + r); 
